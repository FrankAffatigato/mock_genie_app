    ...
    children=[
        ...
        html.Div(
            [
                ...
                html.Hr(style={"border": f"1px solid {ACCENT}", "width": "80%", "margin": "auto"}),
            ]
        ),
        ...
        html.Div(
            ...
            children=[
                html.Div(
                    ...
                    children=[
                        html.H4("Sales by Store", style={"color": TEXT_COLOR}),
                ...
                html.Div(
                    ...
                    children=[
                        html.H4("Monthly Profit Trend", style={"color": TEXT_COLOR}),
                ...
                html.Div(
                    ...
                    children=[
                        html.Div(
                            style={"width": "45%"},
                            children=[
                                html.Label("Select Schema", style={"fontWeight": "bold", "color": TEXT_COLOR}),
                                dcc.Dropdown(
                                    id="schema-dropdown",
                        ...
                        html.Div(
                            style={"width": "45%"},
                            children=[
                                html.Label("Select Table", style={"fontWeight": "bold", "color": TEXT_COLOR}),
                                dcc.Dropdown(id="table-dropdown", clearable=False, style={"color": DARK_BG}),
                            ],
                        ),
                    ],
                ),
        ...
        # Chat Section (Mock AI Assistant)
        html.Div(
            style={
                "backgroundColor": CARD_BG,
                "padding": "25px",
